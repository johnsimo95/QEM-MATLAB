...
%% Initialize
Nc0 = 2.86E19     ; % Coeff. for band edge densities of Si (Diamond same)
Nv0 = 3.1E19      ; % Coeff. for band edge densities of Si (Diamond Nc0*2)
Nd = 1E15         ; % Number of donors cm^-3
Eg =  1.12        ; % 1.12eV Si Gap; 5.5Ev Diamond
Ed =  0.045       ; % Donor level under conduction band (P in Si 0.045eV) 
