...
z2g=22e-6;
zend=55e-6;
wo=128e-9;   %200 nm for 6 mrad conv. angle
ro=-32e-6;  %-30um for 6 mrad conv. angle
lo=25.6e-9;
d1=3.2e-10;
d2=3.2e-10;
z_step=0.2e-6;  %0.2
x=(0:0.25:300)*1e-9;  %0.25,to 300
y=(0:0.25:300)*1e-9;
aa=size(x,2);
z1=0:z_step:z1g;
for i=1:size(z1,2)
...
imwrite(At','c:\\Users\\akshay\\Documents\\MATLAB\\GSM\\spot_images\\diff_bright.jpg');
