function c = SetVariables(computer)
%SETVARIABLES Function sets all the variables I use and also saves
    
    initDirectory = cd ('C:\Users\johns\Documents\Github\QEM-MATLAB');
